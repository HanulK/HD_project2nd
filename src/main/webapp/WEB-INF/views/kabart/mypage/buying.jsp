						...
						<div class="my_purchase">
							...
							<div data-v-0c307fea="" class="purchase_list_tab detail_tab">
								<div data-v-0c307fea="" class="tab_item tab_on" data-value="0">
									<div data-v-0c307fea=""  class="tab_link"><dl data-v-0c307fea="" class="tab_box">
                                ...
                                for (var i = 0; i < result.length; i++) {
                                   ...
                                   row+="<div data-v-50c8b1d2='' class='purchase_list finished bid'><div data-v-50c8b1d2=''><div data-v-2f988574='' data-v-50c8b1d2=''><div data-v-2f988574='' class='purchase_list_display_item' style='background-color: rgb(255, 255, 255);'>"
                                       +"<div data-v-2f988574='' class='purchase_list_product'><div data-v-2f988574='' class='list_item_img_wrap'><img data-v-2f988574='' alt='product_image' src='"+result[i].imgs_src+"' class='list_item_img' style='background-color: rgb(235, 240, 245);'>"
                                           +"</div><div data-v-2f988574='' class='list_item_title_wrap'><p data-v-2f988574='' class='list_item_title'>"+result[i].prod_name+"</p><p data-v-2f988574='' class='list_item_description'>"+price+"</p>"
                                           +"</div></div><div data-v-2f988574='' class='list_item_status'><div data-v-2f988574='' class='list_item_column column_secondary'><p data-v-5f36ea36='' data-v-2f988574='' class='secondary_title display_paragraph' style='color: rgba(34, 34, 34, 0.5);'>"+result[i].order_date+"</p></div>"
                                           +"<div data-v-2f988574='' class='list_item_column column_last'><p data-v-5f36ea36='' data-v-2f988574='' class='last_title display_paragraph' style='color: rgb(34, 34, 34);'>"+status+"</p><p data-v-5f36ea36='' data-v-2f988574='' class='last_description display_paragraph'></p></div></div>"
                                       +"</div></div></div></div>";
                                }
                                }
                		 ...
                		 $.ajax({
                             ...
                             success : function(result){
                                ...
                                if(result.length==0){
                                   ...
                                   var row ="";
                                for (var i = 0; i < result.length; i++) {
                                   var calPrice = result[i].prod_price * (100-result[i].discount_rate)/100;
                                	let price = calPrice.toLocaleString('ko-KR');
                                   console.log(result[i].imgs_src);
                                   var status = '구매확정';

                                   row+="<div data-v-50c8b1d2='' class='purchase_list finished bid'><div data-v-50c8b1d2=''><div data-v-2f988574='' data-v-50c8b1d2=''><div data-v-2f988574='' class='purchase_list_display_item' style='background-color: rgb(255, 255, 255);'>"
                                       +"<div data-v-2f988574='' class='purchase_list_product'><div data-v-2f988574='' class='list_item_img_wrap'><img data-v-2f988574='' alt='product_image' src='"+result[i].img_srcs+"' class='list_item_img' style='background-color: rgb(235, 240, 245);'>"
                                           +"</div><div data-v-2f988574='' class='list_item_title_wrap'><p data-v-2f988574='' class='list_item_title'>"+result[i].prod_name+"</p><p data-v-2f988574='' class='list_item_description'>"+price+"원</p><p data-v-2f988574='' class='list_item_description'>"+result[i].grade+"등급</p>"
                                           +"</div></div><div data-v-2f988574='' class='list_item_status'><div data-v-2f988574='' class='list_item_column column_secondary'><p data-v-5f36ea36='' data-v-2f988574='' class='secondary_title display_paragraph' style='color: rgba(34, 34, 34, 0.5);'>"+result[i].sale_date+"</p></div>"
                                           +"<div data-v-2f988574='' class='list_item_column column_last'><p data-v-5f36ea36='' data-v-2f988574='' class='last_title display_paragraph' style='color: rgb(34, 34, 34);'>"+status+"</p><p data-v-5f36ea36='' data-v-2f988574='' class='last_description display_paragraph'></p></div></div>"
                                       +"</div></div></div></div>";
                                }
                                }
