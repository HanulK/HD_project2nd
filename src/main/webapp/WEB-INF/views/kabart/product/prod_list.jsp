							...
							<div container-index="1" class="shortcut_collection">
								...
								<div class="shortcut_item_wrap">
									<div class="shortcut_item">
										...
										<p class="shortcut_item_title">중고 상품</p>
									</div>
									<div class="shortcut_item">
										<div class="shortcut_item_img_wrap">
										...
										<p class="shortcut_item_title">침 대</p>
									</div>
									<div class="shortcut_item">
										<div class="shortcut_item_img_wrap">
										...
										<p class="shortcut_item_title">소 파</p>
									</div>
									<div class="shortcut_item">
										<div class="shortcut_item_img_wrap">
										...
										<p class="shortcut_item_title">식 탁</p>
									</div>
									<div class="shortcut_item">
										<div class="shortcut_item_img_wrap">
										...
										<p class="shortcut_item_title">의 자</p>
									</div>
									<div class="shortcut_item">
										<div class="shortcut_item_img_wrap">
										...
										<p class="shortcut_item_title">옷 장</p>
									</div>
									<div class="shortcut_item">
										<div class="shortcut_item_img_wrap">
									...
									<div class="shortcut_item">
										...
										<p class="shortcut_item_title">책 상</p>
									</div>
									<div class="shortcut_item">
										<div class="shortcut_item_img_wrap">
									...
									<div class="shortcut_item">
										...
										<p class="shortcut_item_title">전체 보기</p>
									</div>
								</div>
							</div>
								...
								<div class="exhibition_item product_header" data-v-4f87b95c="">
									<div class="exhibition_item_product_header exhibition_item_section" data-v-6e9267c1=""
										...
										<div class="product_header_wrapper" data-v-6e9267c1="">
											<h2 class="title" data-v-6e9267c1="">KABART 상품 전체보기</h2>
											<p class="description" data-v-6e9267c1="">KABART 에서 자신 있게 선보이는 상품</p>
										</div>
									</div>
								</div>
