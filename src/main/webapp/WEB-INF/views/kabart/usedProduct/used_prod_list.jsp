			...
			<div tabindex="0" class="wrap win_os md" data-v-3007c576="">
				...
				<div container-index="1" class="shortcut_collection">
					...
					<div class="shortcut_item_wrap">
						...
						<div class="shortcut_item">
						<a href="/kabart/usedProduct/used_prod_list?prod_category=drawers">
							<div class="shortcut_item_img_wrap">
								<picture class="picture shortcut_item_img_bg"> <img
						...
						<div class="shortcut_item">
						<a href="/kabart/usedProduct/used_prod_list?prod_category=homeinterior">
							<div class="shortcut_item_img_wrap">
								<picture class="picture shortcut_item_img_bg"> <img
				...
				<div class="exhibition_items" data-v-4f87b95c="" data-v-352cdc90=""
					...
					<div class="exhibition_item product_header" data-v-4f87b95c="">
						<div
							...
							<div class="product_header_wrapper" data-v-6e9267c1="">
								<h2 class="title" data-v-6e9267c1="" style="text-transform : uppercase;"><c:out value="${usedProductList[0].prod_category}"/></h2>
								<p class="description" data-v-6e9267c1="">KABART에서 추천하는 명품 중고 상품</p>
							</div>
						</div>
					</div>
							...
							<div class="product_card exhibition_product" data-v-19fda891=""
								...
								<a href="/kabart/usedProduct/used_prod_detail?up_id=<c:out value="${products.up_id }"/>" class="item_inner" data-v-19fda891=""><div
										...
										<picture data-v-321fc3b6="" data-v-09fbcf09=""
											...
											<em data-v-09fbcf09="" class="stocked_status_mark"> <c:out value="${products.grade}"/> </em>
									</div>
									...
									<dd data-v-67511fc2="" class="price">
										<div data-v-67511fc2="" class="discount_amount">
											<em data-v-67511fc2="" class="discount_per"><c:out value="${products.discount_rate}"/> % </em><span
												data-v-67511fc2="" class="num"><fmt:formatNumber value="${products.discount_price }" pattern="#,###" /></span><span
					...
					<div class='pull-right'>
								...
								<!-- 페이징 처리 끝-->
								<div class="soo">
									<form id='actionForm' action='/kabart/usedProduct/used_prod_list' method="get">
