						...
						<div id="__nuxt">
							...
							<div id="__layout">
								<div tabindex="0" class="wrap win_os md" data-v-3007c576="">
									...
									<div data-v-cf786f84="" data-v-3007c576="" class="container detail md">
											...
											<div data-v-cf786f84="" class="column_bind">
												<div data-v-cf786f84="" class="column">
													...
													<div data-v-cf786f84="" class="column_box">
														<div data-v-2998063a="" data-v-cf786f84="" class="detail_banner_area md">
															<div data-v-2998063a="" data-v-e4caeaf8="" class="item_inner">
																<div data-v-09fbcf09="" data-v-2998063a="" class="product" data-v-e4caeaf8="">
																	<picture data-v-321fc3b6="" data-v-09fbcf09="" class="picture product_img"> <img
																			alt="" src="${read.img_srcs}" style="overflow: auto;"></picture>
																</div>
															</div>
														</div>
													</div>
												...
												<div data-v-77d20f30="" class="column">
													<div data-v-67511fc2="" data-v-77d20f30="" class="detail_info_wrap md">
														<div data-v-67511fc2="" class="detail_info">
															<p data-v-67511fc2="" class="size">
																<em data-v-67511fc2="" class="mark_95">${read.grade}</em><span data-v-67511fc2=""
																	class="size_text">${read.prod_name}</span>
															</p>
														</div>
															...
															<dd data-v-67511fc2="" class="price1">
																<div data-v-67511fc2="" class="discount_amount">
																	<em data-v-67511fc2="" class="discount_per">${read.discount_rate}%</em><span
																		data-v-67511fc2="" class="num">
																		<fmt:formatNumber value="${read.used_price}" pattern="#,###" />
																	</span><span data-v-67511fc2="" class="won">원</span>
																</div>
																<div data-v-67511fc2="" class="origin_amount">
																	<span data-v-67511fc2="" class="num">
													...
													<sec:authorize access="isAnonymous()">
														<div data-v-77d20f30="" class="btn_wrap">
															<c:if test="${read.sale_date eq null}">
																<div data-v-f40660fa="" data-v-77d20f30="" class="detail_stock_btn">
																	<a data-v-6e799857="" data-v-f40660fa="" href="#" class="btn solid full buy1 large">
																		구매
																		불가 </a>
																</div>
															</c:if>
															<c:if test="${read.sale_date ne null}">
																<div data-v-f40660fa="" data-v-77d20f30="" class="detail_stock_btn1">
																	<a data-v-6e799857="" data-v-f40660fa="" class="btn solid full buy1 large"> 판매 완료 </a>
																</div>
															</c:if>
														</div>
													</sec:authorize>
													...
													<sec:authorize access="isAuthenticated()">
														...
														<c:if test="${read.mem_id eq user_id}">
															<li class="gnb_item">
																<div data-v-23bbaa82="" data-v-3900a1a2="" class="division_btn_box1 md">
																	<div data-v-f40660fa="" data-v-77d20f30="" class="detail_stock_btn">
																	...
																	<div data-v-f40660fa="" data-v-77d20f30="" class="detail_stock_btn">
																		...
																		<a data-v-6e799857="" data-v-f40660fa="" href="#" class="btn solid full sell large">삭제
														...
														<c:if test="${read.mem_id ne user_id}">
															<div data-v-77d20f30="" class="btn_wrap">
																<c:if test="${read.sale_date eq null}">
																	<div data-v-f40660fa="" data-v-77d20f30="" class="detail_stock_btn">
																		<a data-v-6e799857="" data-v-f40660fa=""  class="btn solid full buy large">
																			바로
																			구매하기 </a>
																	</div>
																</c:if>
																<c:if test="${read.sale_date ne null}">
																	<div data-v-f40660fa="" data-v-77d20f30="" class="detail_stock_btn1">
																		<a data-v-6e799857="" data-v-f40660fa="" class="btn solid full buy1 large"> 판매 완료
																		</a>
																	</div>
																</c:if>
															</div>
													...
													<div data-v-824856a2="" data-v-77d20f30="" class="checked_review" style="padding: 20px 0;">
														<div data-v-3900a1a2="" class="product_info_wrap">
															<h3 data-v-52dd777b="" data-v-3900a1a2="" class="detail_title info_title md"
																style="padding-top: 0px;">상품
																정보</h3>
													...
													<div data-v-2e0c1d1d="" data-v-824856a2="" class="review_section plain top">
													...
													<!---->
													<div data-v-2e0c1d1d="" data-v-824856a2="" class="review_section empty_header">
													...
													<div data-v-2e0c1d1d="" data-v-824856a2="" class="review_section empty_header top">
														<p data-v-2e0c1d1d="" class="title"></p>
				...
				<script type="text/javascript">
					$(document).ready(function () {
						...
						$('button').on("click", function (e) {
							...
							if (operation === 'remove') {
								formObj.attr("action", "/kabart/usedProduct/used_prod_detail_remove?up_id=${read.up_id}");
							}
							formObj.submit();
						});
					});
