																...
																<c:choose>
																	...
																	<c:when test="${empty read.sale_date }">
																		<div data-v-23bbaa82="" data-v-3900a1a2="" class="division_btn_box1 md">
																			...
																			<div data-v-f40660fa="" data-v-77d20f30="" class="detail_stock_btn">
																				<button type="submit" data-oper='remove' style="width: 100%;">
					...
					$(document).ready(function () {
								...
								$('button')
									.on(
										...
										$(".review_item").on("click", "li", function(e) {
										...
										function showImage(fileCallPath) {
											...
											$(".bigPicture").html("<img src='/kabart/usedProduct/display?fileName="+fileCallPath+"'>").animate({width:'100%', height: '100%'}, 1000);
										}
