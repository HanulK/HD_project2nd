...
<body>
	<form role="form"
		action='/kabart/usedProduct/used_prod_sell?prod_id=${detail.prod_id}'
		method="post">
								...
								<div data-v-158ed304="" data-v-877ed62a=""
									...
									<ul data-v-638c1354="" data-v-158ed304="" class="price_list">
										<li data-v-638c1354="" class="list_item">
											<p data-v-638c1354="" class="title">정가</p> <span
											data-v-638c1354="" class="price"> <fmt:formatNumber
													value="${detail.prod_price}" pattern="#,###" />
										</span><span data-v-638c1354="" class="unit">원</span>
										</li>
										<li data-v-638c1354="" class="list_item">


											<p data-v-638c1354="" class="title">검수 등급</p> <select
											name="grade" id="grade" onChange="calculatePay()">
